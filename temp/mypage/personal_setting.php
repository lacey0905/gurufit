					...
					<tr class="personal_info">
						...
						<td>
							<dl>
								...
								<dd>단호박정식</dd>
								<dt>휴대전화번호</dt>
								<dd>010-4321-1234<i class="fa fa-check" aria-hidden="true"></i></dd>
								<dt>생년월일</dt>
								<dd>1980년 11월 15일</dd>
								<dt>성별</dt>
								<dd>
						...
						<td>
							<dl>
								...
								<dd class="new_contents">
									...
									<dl>
										...
										<dt>연관 콘텐츠</dt>
										<dd>장바구니 및 마이 리스트에 담긴 상품/콘텐츠와 연관된 콘텐츠를 이메일로 보내드립니다.</dd>
									</dl>	
								</dd>
								<dd>
									<dl>
							...
							<dl class="website_area">
								...
								<dd>
									<dl>
										<dt>알림 갯수 표시</dt>
										<dd>읽지 않은 웹사이트 알림 갯수를 표시합니다.</dd>
										<dd><img src="../img/website_alarm.png" alt="#"></dd>
									</dl>
								</dd>
								<dd>
									<dl>
										<dt>알림 갯수 표시</dt>
										<dd>새로운 알림이 있는 경우 팝업으로 내용을 표시합니다.</dd>
									</dl>
								</dd>
							</dl>
						</td>						
