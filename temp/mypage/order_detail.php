...
<section class="sub_layout">
	...
	<article class="sub_content custom_inner">
		...
		<div class="tit_sub_wrap">
			<h3 class="tit_head tit_sub_b">구매내역</h3>
		</div>
		<section id="mypage">
    				...
    				<table class="prd_list_a">
    					...
    					<thead>
    						<tr>
    							<th colspan="3">
    								...
    								<div class="prd_order_r">
    									<div class="state_icon">
    										<a href="#" class="state_add_btn btn_hover_a">증빙서류 발급</a>
    					...
    					<tbody>
    						<tr>
    							...
    							<td class="btn">
    								<div class="top_msg">* 배송이 진행이 되면 배송지 변경 및 상품 옵션 및 주문 취소를 하실 수 없습니다.</div>
    								<ul class="prd_list_btn">
    									<li>
    										<a href="#" class="btn_ btn_x_s2 btn_rnd_x1 btn_hover_a btn_np2">교환신청</a>
										</li>
